...
class PersonaClientIntegrationTest extends TestBase {
    ...
    function testObtainNewTokenWithValidScope(){
        $tokenDetails = $this->personaClient->obtainNewToken("primate");
    ...
    function testObtainNewTokenThrowsExceptionForInvalidScope(){
        ...
        $tokenDetails = $this->personaClient->obtainNewToken('wibble');
    }
    ...
    function testValidateToken(){
        $tokenDetails = $this->personaClient->obtainNewToken();
        $this->assertTrue($this->personaClient->validateToken($tokenDetails['access_token']));
    }
}